...
import 'class22_workflow_call_inputs_pattern_property1.dart';
...
class Class22WorkflowCallInputs {
  final Map<String, Class22WorkflowCallInputsPatternProperty1>?
  patternProperties;

  const Class22WorkflowCallInputs({this.patternProperties});

  factory Class22WorkflowCallInputs.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    var unmatched = Map<String, dynamic>.from(remaining);
    Map<String, Class22WorkflowCallInputsPatternProperty1>?
    patternPropertiesValue;
    {
      final patternPropertiesMap =
          <String, Class22WorkflowCallInputsPatternProperty1>{};
      ...
      for (final entry in unmatched.entries) {
        ...
        if (!matched && RegExp('^[_a-zA-Z][a-zA-Z0-9_-]*\$').hasMatch(key)) {
          patternPropertiesMap[key] =
              Class22WorkflowCallInputsPatternProperty1.fromJson(
    ...
    return Class22WorkflowCallInputs(patternProperties: patternPropertiesValue);
  }
