...
class Class22WorkflowCallOutputs {
  final Map<String, Class22WorkflowCallOutputsPatternProperty1>?
  patternProperties;

  const Class22WorkflowCallOutputs({this.patternProperties});
  ...
  factory Class22WorkflowCallOutputs.fromJson(Map<String, dynamic> json) {
    ...
    Map<String, Class22WorkflowCallOutputsPatternProperty1>?
    patternPropertiesValue;
    {
      final patternPropertiesMap =
          <String, Class22WorkflowCallOutputsPatternProperty1>{};
      ...
      for (final entry in unmatched.entries) {
        ...
        if (!matched && RegExp('^[_a-zA-Z][a-zA-Z0-9_-]*\$').hasMatch(key)) {
          patternPropertiesMap[key] =
              Class22WorkflowCallOutputsPatternProperty1.fromJson(
