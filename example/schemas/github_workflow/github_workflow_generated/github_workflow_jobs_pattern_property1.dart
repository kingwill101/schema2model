...
sealed class GithubWorkflowJobsPatternProperty1 {
  ...
  factory GithubWorkflowJobsPatternProperty1.fromJson(
    Map<String, dynamic> json,
  ) {
    final keys = json.keys.toSet();
    final sortedKeys = keys.toList()..sort();
    final requiredMatches =
        <GithubWorkflowJobsPatternProperty1 Function(Map<String, dynamic>)>[];
    ...
    if (requiredMatches.length > 1) {
      throw ArgumentError(
        'Ambiguous GithubWorkflowJobsPatternProperty1 variant matched required-property heuristics: ${requiredMatchNames.join(', ')}',
      );
    }
    throw ArgumentError(
      'No GithubWorkflowJobsPatternProperty1 variant matched heuristics (keys: ${sortedKeys.join(', ')}).',
    );
  }
