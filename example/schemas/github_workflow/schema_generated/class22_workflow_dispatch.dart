...
class Class22WorkflowDispatch {
  ...
  const Class22WorkflowDispatch({
    this.inputs,
  });

  factory Class22WorkflowDispatch.fromJson(Map<String, dynamic> json) {
    final remaining = Map<String, dynamic>.from(json);
    final inputs = json['inputs'] == null ? null : Class22WorkflowDispatchInputs.fromJson((json['inputs'] as Map).cast<String, dynamic>());
    ...
    return Class22WorkflowDispatch(
      inputs: inputs,
    );
  }
