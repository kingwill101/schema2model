...
class Class22WorkflowCallInputs {
  final Map<String, Class22WorkflowCallInputsPatternProperty1>? patternProperties;

  const Class22WorkflowCallInputs({
  ...
  factory Class22WorkflowCallInputs.fromJson(Map<String, dynamic> json) {
    ...
    Map<String, Class22WorkflowCallInputsPatternProperty1>? patternPropertiesValue;
    {
      final patternPropertiesMap = <String, Class22WorkflowCallInputsPatternProperty1>{};
      ...
      for (final entry in unmatched.entries) {
        ...
        if (!matched && RegExp('^[_a-zA-Z][a-zA-Z0-9_-]*\$').hasMatch(key)) {
          patternPropertiesMap[key] = Class22WorkflowCallInputsPatternProperty1.fromJson((value as Map).cast<String, dynamic>());
          matched = true;
        }
        if (!matched) {
    ...
    return Class22WorkflowCallInputs(
