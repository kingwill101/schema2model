...
class GithubWorkflowJobs {
  ...
  factory GithubWorkflowJobs.fromJson(Map<String, dynamic> json) {
    ...
    {
      final patternPropertiesMap = <String, GithubWorkflowJobsPatternProperty1>{};
      ...
      for (final entry in unmatched.entries) {
        ...
        if (!matched && RegExp('^[_a-zA-Z][a-zA-Z0-9_-]*\$').hasMatch(key)) {
          patternPropertiesMap[key] = GithubWorkflowJobsPatternProperty1.fromJson((value as Map).cast<String, dynamic>());
          matched = true;
        }
        if (!matched) {
